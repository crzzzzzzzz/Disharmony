...
cc.Class({
    ...
    judge_Processing: function (location) {
        ...
        if (this[location+'ColorBlockQueue'][this[location+'ColorBlockQueue'].length - 1][0].y < -1237 && this[location+'ColorBlockQueue'][this[location+'ColorBlockQueue'].length - 1][0].y > -1311 && this[location+'IsCorrect'] != true) {
            ...
            if (this[location+'JudgeFlag'] == true) {
                ...
                if (this[location+'IsCorrect']) {
                    ...
                    //cc.log(this[location+'JudgeFlag']);
                } else {
